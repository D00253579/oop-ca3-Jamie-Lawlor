...
public class CA3_Question7
{
    ...
    public static void main(String[] args) {
        ...
        String command;
        //Creating the queue
        Queue<CA3_Question6.Block>shares=new LinkedList<>();
        do {
            ...
            if(command.equalsIgnoreCase("buy"))
            {
                ...
                CA3_Question6.Block sharesBought=new CA3_Question6.Block(qty,price);
                shares.add(sharesBought);
                System.out.println("Shares purchased successfully");
            }
            else if(command.equals("sell")) {
                String company = in.next();
                CA3_Question6.Block firstBatchOfShares = shares.peek();
                ...
                if (!shares.isEmpty()) {
                    ...
                    if (qty > 0) {
                        ...
                        if (qty > firstBatchOfShares.getQuantity()){
                            ...
                            CA3_Question6.Block secondBatchOfShares=shares.peek();
                            if (secondBatchOfShares!=null) {
                                ...
                                */
                                ...
                                shares.add(new CA3_Question6.Block(remainingShares, secondBatchOfShares.getPrice()));
                                shares.remove();
